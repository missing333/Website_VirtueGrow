...
<body class="gradient-pattern">
	<div id="wrapper">
		...
		<div id="mainSection" class="mainSection">
			<div id="privacy" class="whitebox">
				<h2>Privacy Policy</h2>
				<p>This Privacy Policy governs the manner in which Virtue Grow collects, uses, maintains and discloses information collected from users (each, a "User") of the http://www.virtuegrow.com website ("Site").</p>
				...
				<p>Virtue Grow may collect and use Users personal information for the following purposes:</p>
				<ul>
				  <li>
				...
				<p>Virtue Grow has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
